...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:vitu\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=558681467600:+55 868146-7600\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] deu n  ❌',
					ownerB: '[❗] tbm n ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de vitu. Registre-se para fazer amizade com o bot vitu por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar nabuto|14\n\n──「 vitu BOT 」──`,
			...
			const ownerNumber = ["55@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"558681467600@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["558681467600@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["558681467600@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558681467600@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
// recursos anime, random @nabuto domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT vITU ✨* 」\n*│+ wa.me/558681467600*╰──────*「 *vitu* 」*────*\n\n*_SE QUER SER ADMIN DO BOT viTU*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️canal nao'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*WPP:* wa.me/+558681467600\n*\n\nEspero que tenham gostado do bot️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
			...
			reply(mess.wait)
                ...
                case 'marcar2':
                 ...
                 case 'marcar3':
					...
					break
				case 'limpar':
					if (!isOwner) return reply('so editor pode')
